...
namespace Cluster
{
    ...
    public class AsynchronousSocketListener
    {
        ...
        public static void StartListening(int port)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    Console.WriteLine("Waiting for a connection... {0}", localEndPoint);
        ...
        public static void AcceptCallback(IAsyncResult ar)
        {
            ...
            long clientnumber = Interlocked.Read(ref clientid);
